...
<div id="upload-page" class="container">
    ...
    <div class="content">
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <form action="/create" method="POST" class="form-horizontal" enctype="multipart/form-data" onsubmit="return checkForm()">
                {{ csrf_field() }}

                <div class="form-group">
                    <label for="pName" class="col-sm-3 control-label">What is the name of your project?</label>
                    <div class="col-sm-5">
